namespace Application.Interfaces.Repository.GroupMembership
{
    public interface IGroupMembershipWriteRepository
    {
        ...
        Task<Domain.GroupMembership.GroupMembership?> GetAnyActiveAsync(Guid userId, Guid groupId, CancellationToken cancellationToken);
        Task<Domain.GroupMembership.GroupMembership?> GetAnyAsync(Guid userId, Guid groupId, CancellationToken cancellationToken);
        Task<List<Domain.GroupMembership.GroupMembership>> GetByGroupIdAsync(Guid groupId, CancellationToken cancellationToken);
    }
}
