...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260301205051_AddFinishReasonAndOutcomePropertiesToGameSessionTable")]
    partial class AddFinishReasonAndOutcomePropertiesToGameSessionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BoardStateSnapshot.BoardStateSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.DiceRollSnapshot.DiceRollSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.GamePlayer.GamePlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.GameSession.GameSession", b =>
                {
                    ...
                    b.Property<bool>("CrawfordRuleApplies")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.DiceRollSnapshot.DiceRollSnapshot", b =>
                {
                    b.HasOne("Domain.PlayerTurn.PlayerTurn", "PlayerTurn")
                        .WithOne("DiceRollSnapshot")
                        .HasForeignKey("Domain.DiceRollSnapshot.DiceRollSnapshot", "PlayerTurnId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Domain.GamePlayer.GamePlayer", b =>
                {
                    b.HasOne("Domain.GameSession.GameSession", "GameSession")
                        .WithMany("Players")
            ...
            modelBuilder.Entity("Domain.Game.Game", b =>
                {
                    b.Navigation("BoardStateSnapshots");
